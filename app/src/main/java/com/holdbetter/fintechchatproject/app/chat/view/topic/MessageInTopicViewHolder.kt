...
class MessageInTopicViewHolder(
    itemView: View,
    ...
    companion object {
        ...
        ): MessageInTopicViewHolder {
            val view = if (isMyselfMessage) {
                inflater.inflate(R.layout.myself_message_in_topic_instance, parent, false)
            } else {
                inflater.inflate(R.layout.foreign_message_in_topic_instance, parent, false)
            }
            return MessageInTopicViewHolder(view, reactionListener, emojiDialogShower)
        }
    }
